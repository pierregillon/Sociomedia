...
namespace Sociomedia.Articles.Tests.UnitTests
{
    public class HtmlParserTests
    {
        ...
        {
            var html = File.ReadAllText("./UnitTests/Resources/article_example.html");
        ...
        {
            var html = ReadAllText("marianne_article_example.html");
        ...
        {
            var html = ReadAllText("marianne_article_example2.html");
        ...
        {
            var html = ReadAllText("euronews_article_example.html");
        ...
        {
            var html = ReadAllText("figaro_article_example.html");
        ...
        {
            var html = ReadAllText("leparisien_article_example.html");
        ...
        {
            var html = ReadAllText("figaro_article_example2.html");
        ...
        {
            return File.ReadAllText(Path.Combine("./UnitTests/Resources/", fileName));
        }
    }
}